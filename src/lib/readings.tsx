...
//   const data = await res.json();
    ...
    const data = {
		posts: [
			{
				...
				text: `<dl class="reading">
						...
						<dd>So when they had eaten breakfast, Jesus said to Simon Peter, “Simon, son of Jonah, do you love Me more than these?” He said to Him, “Yes, Lord; You know that I love You.” He said to him, “Feed My lambs.”</dd>
											<dt>16</dt>
						<dd>He said to him again a second time, “Simon, son of Jonah, do you love Me?” He said to Him, “Yes, Lord; You know that I love You.” He said to him, “Tend My sheep.”</dd>
											<dt>17</dt>
						<dd>He said to him the third time, “Simon, son of Jonah, do you love Me?” Peter was grieved because He said to him the third time, “Do you love Me?” And he said to Him, “Lord, You know all things; You know that I love You.” Jesus said to him, “Feed My sheep.</dd>
											<dt>18</dt>
						<dd>Most assuredly, I say to you, when you were younger, you girded yourself and walked where you wished; but when you are old, you will stretch out your hands, and another will gird you and carry you where you do not wish.”</dd>
											<dt>19</dt>
						<dd>This He spoke, signifying by what death he would glorify God. And when He had spoken this, He said to him, “Follow Me.”</dd>
											<dt>20</dt>
						<dd>Then Peter, turning around, saw the disciple whom Jesus loved following, who also had leaned on His breast at the supper, and said, “Lord, who is the one who betrays You?”</dd>
											<dt>21</dt>
						<dd>Peter, seeing him, said to Jesus, “But Lord, what about this man?”</dd>
											<dt>22</dt>
						<dd>Jesus said to him, “If I will that he remain till I come, what is that to you? You follow Me.”</dd>
											<dt>23</dt>
						<dd>Then this saying went out among the brethren that this disciple would not die. Yet Jesus did not say to him that he would not die, but, “If I will that he remain till I come, what is that to you?”</dd>
											<dt>24</dt>
						<dd>This is the disciple who testifies of these things, and wrote these things; and we know that his testimony is true.</dd>
											<dt>25</dt>
			...
			},
			{
				...
				text: `<dl class="reading">
						...
						<dd>This is a faithful saying and worthy of all acceptance.</dd>
											<dt>10</dt>
						<dd>For to this end we both labor and suffer reproach, because we trust in the living God, who is the Savior of all men, especially of those who believe.</dd>
											<dt>11</dt>
						<dd>These things command and teach.</dd>
											<dt>12</dt>
						<dd>Let no one despise your youth, but be an example to the believers in word, in conduct, in love, in spirit, in faith, in purity.</dd>
											<dt>13</dt>
						<dd>Till I come, give attention to reading, to exhortation, to doctrine.</dd>
											<dt>14</dt>
						<dd>Do not neglect the gift that is in you, which was given to you by prophecy with the laying on of the hands of the eldership.</dd>
											<dt>15</dt>
			...
			},
			{
				...
				text: `<dl class="reading">
						...
						<dd>Then Jesus entered and passed through Jericho.</dd>
											<dt>2</dt>
						<dd>Now behold, there was a man named Zacchaeus who was a chief tax collector, and he was rich.</dd>
											<dt>3</dt>
						<dd>And he sought to see who Jesus was, but could not because of the crowd, for he was of short stature.</dd>
											<dt>4</dt>
						<dd>So he ran ahead and climbed up into a sycamore tree to see Him, for He was going to pass that way.</dd>
											<dt>5</dt>
						<dd>And when Jesus came to the place, He looked up and saw him, and said to him, “Zacchaeus, make haste and come down, for today I must stay at your house.”</dd>
											<dt>6</dt>
						<dd>So he made haste and came down, and received Him joyfully.</dd>
											<dt>7</dt>
						<dd>But when they saw it, they all complained, saying, “He has gone to be a guest with a man who is a sinner.”</dd>
											<dt>8</dt>
						<dd>Then Zacchaeus stood and said to the Lord, “Look, Lord, I give half of my goods to the poor; and if I have taken anything from anyone by false accusation, I restore fourfold.”</dd>
											<dt>9</dt>
						<dd>And Jesus said to him, “Today salvation has come to this house, because he also is a son of Abraham;</dd>
											<dt>10</dt>
		...
		<header id="content-header">
			<time datetime="01-29">
				Commemorated on <a href="https://www.oca.org/saints/lives/2023/01/29">January 29</a>
					...
					<figure class="alignright onehalf gallery">
								<span>
					<a rel="featured-saint" href="https://images.oca.org/icons/lg/january/0129aignatiustheophorus.jpg"><img src="https://images.oca.org/icons/sm/january/0129aignatiustheophorus.jpg"></a>				</span>
		...
		<p class="byline">WASHINGTON, DC [OCA]</p>
		<figure class="aligncenter"><span><img src="https://images.oca.org/news/2022-0121-mettikhon10thanni15__large.jpg" alt="tikhon"></span></figure><p>January 27, 2023 marks the tenth anniversary of the enthronement of His Beatitude <a href="https://www.oca.org/holy-synod/bishops/the-most-blessed-tikhon">Metropolitan Tikhon</a>.</p>

<p>To <a href="https://www.oca.org/media/photos/metropolitan-tikhon-presides-at-divine-liturgy-to-celebrate-the-tenth-anniversary-of-his-primatial-enthronement">commemorate the event</a>, His Beatitude presided at the celebration of the Hierarchical Divine Liturgy on Saturday, January 21 at Saint Nicholas Cathedral, Washington, DC. Concelebrating with His Beatitude were Archpriest Alexander Rentel, OCA Chancellor, Priest Alessandro Margheritino, OCA Secretary, Archpriest John Vitko, Archdiocesan Chancellor, and several other archdiocesan clergy. Juliana Woodill led the Archdiocesan Choir.</p>

<p>Before the Divine Liturgy, His Beatitude ordained Reader Alexander Woodill to the subdiaconate. Following the service, a lunch was served in His Beatitude’s honor.</p>

<p>His Beatitude was enthroned in 2013 at Saint Nicholas Cathedral, Washington DC. As Primate, he has been responsible for overseeing the entire Orthodox Church in America and has worked to strengthen the Church’s presence and influence in North America.</p>

<p>In addition to his primatial duties, he has also had archpastoral oversight of the Archdiocese of Washington and the Stavropegial Institutions of the Orthodox Church in America.</p>

<p>During his tenure as Metropolitan, His Beatitude presided at the assembly of three <a href="/history-archives/aacs">All-American Councils</a>, the adoption of the new <a href="/statute"><em>Statute</em> of the Orthodox Church in America</a>, and the relocation of the Primate and Chancery offices.</p>

<p>Throughout his tenure, Metropolitan Tikhon has been a dedicated servant of the Church and has worked diligently to promote the Orthodox faith and strengthen the Church’s presence in North America.</p>

<p>The Orthodox Church in America extends its gratitude to His Beatitude for his archpastoral leadership and care. May God grant His Beatitude many years!</p><p><a class="button" href="/media/photos/metropolitan-tikhon-celebrates-the-tenth-anniversary-of-his-primatial-enthronement"><span>View photo gallery</span></a></p>
